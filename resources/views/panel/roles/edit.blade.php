                            ...
                            <form action="{{ route('roles.update', $role->id) }}" method="post">
                                ...
                                <div class="row">
                                    <div class="mb-2 col-xl-3 col-lg-3 col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="label" id="label" value="{{ $role->label }}" placeholder="مدیر فروش">
                                        @error('label')
                                    ...
                                    <div class="mb-2 col-xl-3 col-lg-3 col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name" value="{{ $role->name }}" placeholder="sales-manager">
                                        @error('name')
                                            <div class="invalid-feedback text-danger d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
